import 'package:project_api1/widget/Container_Widget.dart';
import 'package:project_api1/widget/ElevatedButton_Widget.dart';
import 'package:project_api1/widget/KAppBar.dart';
...
class UserInputView extends GetView<UserInputController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const KAppBar(title: "Git Input"),
      body: Center(
                  ...
                  Padding(
                      ...
                      child: KtextFeild(
                        ...
                        labelStyle: TextStyle(
                          color:
                              istheme.theme.value ? Colors.green : Colors.amber,
                        ),
